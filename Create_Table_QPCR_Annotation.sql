 CREATE TABLE "TM_LZ"."LT_QPCR_MIRNA_ANNOTATION" 
  ...
  CREATE TABLE "TM_LZ"."LT_SRC_MIRNA_DEAPP_ANNOT" 
   ...
   --------------------------------------------------------------
  CREATE SEQUENCE  "TM_CZ"."SEQ_PROBESET_ID"  MINVALUE 249739 MAXVALUE 99999999 INCREMENT BY 1 START WITH 1109908 CACHE 20 	NOORDER  NOCYCLE ;
...
--------------------------------------------------
   ...
   CREATE SEQUENCE  "BIOMART"."SEQ_BIO_DATA_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999 INCREMENT BY 1 START WITH 	391513390 CACHE 20 NOORDER  NOCYCLE ;
